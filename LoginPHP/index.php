...
if (!empty($_POST)){
    ...
    if ($rows > 0){
		...
		http://localhost/tiendaonline/index.php';
...
<html lang="en">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="blue">Sistema </span>
									<span class="white" id="id-text2">de Usuarios</span>
								</h1>
								<h4 class="red" id="id-company-text">&copy; TIENDA ONFASH</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="social-or-login center">
												<span class="bigger-110">Siguenos</span>
											</div>

											<div class="space-6"></div>

											<div class="social-login center">
												<a href="https://www.youtube.com/channel/UCCBFINSAtYxGFvxz-kgB8jg" target="_blank" class="btn btn-danger">
												...
												<a href="https://www.instagram.com/innovation_fashion/" target="_blank" class="btn btn-danger">
	...
	<div class="space-6"></div>
		<p>Ingresa los datos solicitados acontinuacion porfavor: </p>
		<form action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST" >
			<fieldset>
			            <label class="block clearfix">
					<span class="block input-icon input-icon-right">
